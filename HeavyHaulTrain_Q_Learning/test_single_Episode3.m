...
reference_speeds = [60/3.6 65/3.6];
...
for etr = 1 : episode_loops
    ...
    if etr < episode_loops/2
        reference_speed = reference_speeds(1);
    else
        reference_speed = reference_speeds(2);
    end
...
%         X = X_;
        ...
        errV(itr, :) = sum((X(1:Nt, :) - reference_speed).^2);
