function W_obj = get_Wobj_linear_Nonlinear_Offline(nNodes, maxS, maxV, detaS, detaV, nTiling, nAction)
...
W2 = rand(nAction, nNodes)*1e-2;  % initialization weight
...
% nNotch = 10;
nearby_index = [-1; 0; 1]*[1 1 1] + [1; 1; 1]*[-nNotch 0 nNotch];
W_obj.nearby_index = nearby_index(:);
